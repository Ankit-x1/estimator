...
class JAXBackend(Backend):
    ...
    def __init__(self, use_jit: bool = False):
        ...
        self._matmul = jit(jnp.matmul) if use_jit else jnp.matmul
        self._inv = jit(jnp.linalg.inv) if use_jit else jnp.linalg.inv
        self._cholesky = jit(jnp.linalg.cholesky) if use_jit else jnp.linalg.cholesky
        self._solve = jit(jnp.linalg.solve) if use_jit else jnp.linalg.solve
